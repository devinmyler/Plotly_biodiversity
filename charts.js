function init() {
  ...
  d3.json("Plotly_biodiversity/samples.json").then((data) => {
...
// check with map/slice switched
    ...
    for(let i=0; i<10; i++){
      barData[0].marker.color.push(`olive`);
    }
    ...
    var barLayout = {
     title: "<span style= 'color: rgb(2, 2, 2)'><b> Top 10 Bacteria Cultures Found </b> </span> ",
...
//Bubble Chart
    ...
    var bubbleLayout = {
      title: "<span style= 'color: rgb(2, 2, 2)'><b> Bacteria Cultures per Sample </b></span>",
...
//3.select
  ...
  function gaugeChart (washingFreqval) {
    ...
    var gaugeLayout = { 
      title: { text: "<span style= 'color: rgb(2, 2, 2)'><b> Belly Button Washing Frequency</b> </span> <br> <span style= 'font-size: .8em; color: dimgrey'> Scrubs per Week </span>"} ,
      width: 550,
      height: 400,
